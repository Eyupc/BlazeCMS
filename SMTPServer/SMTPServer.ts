...
export class SMTPServer {
  private server: Transporter;
  private static _SMTPServer: SMTPServer | null = null;
  public static GetInstance() {
    if (this._SMTPServer == null) this._SMTPServer = new SMTPServer();
  ...
  public async sendResetMail(to: string, username: string) {
    const token = jwt.sign(
      { username: username, mail: to },
    ...
    this.server.sendMail(
      {
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <h1 style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 22px; ">Reset your user's password</h1>
        ...
        <p style="line-height: 140%;">To reset <b>${username}</b>'s password u need to click on the button below.
        This link is only valid for <b>10 minutes</b>.</p>
          </div>
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
            <p style="line-height: 140%;">- Blaze Team</p>
          </div>
